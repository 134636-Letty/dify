...
import core.app.task_pipeline.easy_ui_based_generate_task_pipeline as pipeline_module
...
class _DatabaseBinding:
    """Expose the real disposable engine used by production-owned sessions."""
...
class TestMessageEndStreamResponseFiles:
    ...
    def bind_sqlite_engine(self, sqlite_engine: Engine, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(pipeline_module, "db", _DatabaseBinding(sqlite_engine))
